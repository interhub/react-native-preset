...
- [expo react native doc](https://docs.expo.io/)
- [typescript doc](https://www.typescriptlang.org/docs/)
- [react native code push doc](https://github.com/microsoft/react-native-code-push/tree/master/docs)
- [react testing enzyme doc](https://enzymejs.github.io/enzyme/)
- [jest js testing doc](https://jestjs.io/docs/en/getting-started.html)
